...
class UpdatedTestAgentComponent(Component):
    display_name: str = "Updated Test Agent"
    description: str = "Updated Test Agent - A specialized Ariba agent for testing and validation tasks."
    icon: str = "bot"
    name: str = "UpdatedTestAgent"
    ...
    inputs = [
        ...
        MessageTextInput(
            ...
            info="The message or task to send to the Updated Test Agent",
            tool_mode=True,
        ),
        MultilineInput(
    ...
    AGENT_ID = "0c1acd55-265e-4599-9057-b13cba5404c9"
    ...
    async def message_response(self) -> Message:
        """Execute the Updated Test Agent and return the response as a Message."""
        if not self.input_value:
            return Message(
                text="Please provide a message or task for the Updated Test Agent to execute.",
                sender="Updated Test Agent",
                sender_name="Updated Test Agent",
            )
        ...
        try:
            ...
            error_msg = f"Error executing Updated Test Agent: {e!s}"
            return Message(
                text=error_msg,
                sender="Updated Test Agent",
                sender_name="Updated Test Agent",
        ...
        try:
            ...
            if agent_data:
                ...
                if "agent_name" in build_config:
                    build_config["agent_name"]["value"] = agent_data.get("name", "Updated Test Agent")
