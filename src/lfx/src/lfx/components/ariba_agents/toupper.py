...
class ToUpperComponent(Component):
    ...
    inputs = [
        ...
        StrInput(
            ...
            value="Text transformation and uppercase conversion",
            advanced=False,
        ),
        MultilineInput(
            ...
            value="You are toUpper, a specialized agent for text transformation and uppercase conversion tasks.",
            advanced=False,
        ),
        IntInput(
            ...
            async with httpx.AsyncClient() as client:
                ...
                if agent_data:
                    ...
                    if "agent_name" in build_config:
                        build_config["agent_name"]["value"] = agent_data.get("name", "toUpper")
                    
                    if "expertise" in build_config:
                        build_config["expertise"]["value"] = agent_data.get("expertIn", "Text transformation and uppercase conversion")
                    
                    if "initial_instructions" in build_config:
                        build_config["initial_instructions"]["value"] = agent_data.get("initialInstructions", "You are toUpper, a specialized agent for text transformation and uppercase conversion tasks.")
