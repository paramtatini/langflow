...
class BidAnalysis2Component(Component):
    ...
    inputs = [
        ...
        StrInput(
            ...
            value="Advanced bid analysis and evaluation",
            advanced=False,
        ),
        MultilineInput(
            ...
            value="You are BidAnalysis2, a specialized agent for advanced bid analysis and evaluation tasks.",
            advanced=False,
        ),
        IntInput(
            ...
            async with httpx.AsyncClient() as client:
                ...
                if agent_data:
                    ...
                    if "agent_name" in build_config:
                        build_config["agent_name"]["value"] = agent_data.get("name", "BidAnalysis2")
                    
                    if "expertise" in build_config:
                        build_config["expertise"]["value"] = agent_data.get("expertIn", "Advanced bid analysis and evaluation")
                    
                    if "initial_instructions" in build_config:
                        build_config["initial_instructions"]["value"] = agent_data.get("initialInstructions", "You are BidAnalysis2, a specialized agent for advanced bid analysis and evaluation tasks.")
